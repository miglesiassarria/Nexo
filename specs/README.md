...
| [0007](0007-acceso-red-local/spec.md) | Acceso desde la red local | `tasks` | Requiere [ADR 0003](../docs/adr/0003-acceso-desde-la-red-local.md); el modo local no cambia en nada, condición explícita del usuario |
